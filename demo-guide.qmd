...
1. **Column typo** (`review_score` instead of `rating`): Spark catches this at query planning time before scanning any data. The AnalysisException tells you exactly which column is missing.
